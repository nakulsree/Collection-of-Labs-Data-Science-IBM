...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=max_payload, 
                                    step=1000,
                                    marks={int(value): str(value) for value in range(int(min_payload), int(max_payload) + 1, 1000)},
...
def scatter(entered_site, payload):
    filtered_df = spacex_df[
        spacex_df['Payload Mass (kg)'].between(payload[0], payload[1]) #found out about the between function
    ]
